...
(function() {
	 ...
	 */
	sap.ui.base.ManagedObject.extend("sap.ui.app.MockServer", /** @lends sap.ui.app.MockServer */
	{
		constructor : function(sId, mSettings, oScope) {
			sap.ui.base.ManagedObject.apply(this, arguments);
			sap.ui.app.MockServer._aServers.push(this);
		},
		...
		metadata : {
			properties : {
				 ...
				 * @public
				 * @name sap.ui.app.MockServer#setRootUri
				 * @function
				 */
				 ...
				 * @public
				 * @name sap.ui.app.MockServer#getRootUri
				 * @function
				 */
				rootUri : "string",
				 ...
				 * @public
				 * @name sap.ui.app.MockServer#setRequests
				 * @function
				 */
				 ...
				 * @public
				 * @name sap.ui.app.MockServer#getRequests
				 * @function
				 */
	 ...
	 * @public
	 */
	sap.ui.app.MockServer.prototype.start = function() {
		this._oServer = sap.ui.app.MockServer._getInstance();
		this._aFilters = [];
	 ...
	 * @public
	 */
	sap.ui.app.MockServer.prototype.stop = function() {
		if (this.isStarted()) {
	 ...
	 * @public
	 */
	sap.ui.app.MockServer.prototype.isStarted = function() {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._loadMetadata = function(sMetadataUrl) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._findEntitySets = function(oMetadata) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._findEntityTypes = function (oMetadata) {
		var mEntityTypes = {};
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._findComplexTypes = function (oMetadata) {
		var mComplexTypes = {};
	 ...
	 * @private 
	 */
	sap.ui.app.MockServer.prototype._createKeysString = function(aKeys, oEntry) {
	 ...
	 * @private 
	 */
	sap.ui.app.MockServer.prototype._loadMockdata = function(mEntitySets, sBaseUrl) {
	 ...
	 * @private 
	 */
	sap.ui.app.MockServer.prototype._enhanceWithMetadata = function(oEntitySet, oMockData) {
		if (oMockData) {
			var that = this,
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._generateDataFromEntity = function(oEntityType, iIndex, mComplexTypes) {
		var oEntity = {};
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._generateDataFromEntitySet = function(oEntitySet, mEntityTypes, mComplexTypes) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._generateMockdata = function(mEntitySets, oMetadata) {
		// load the entity sets (map the entity type data to the entity set)
	 ...
	 * @public
	 */
	sap.ui.app.MockServer.prototype.simulate = function(sMetadataUrl, sMockdataBaseUrl) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._removeAllRequestHandlers = function() {
		var aRequests = this.getRequests();
		var iLength = aRequests.length;
		for (var i = 0; i < iLength; i++) {
			sap.ui.app.MockServer._removeResponse(aRequests[i].response);
		}
	};
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._removeAllFilters = function() {
		for (var i = 0; i < this._aFilters.length; i++) {
			sap.ui.app.MockServer._removeFilter(this._aFilters[i]);
		}
		this._aFilters = null;
	};
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._addRequestHandler = function(sMethod, sPath, fnResponse) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._createRegExp = function(sPattern) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._createRegExpPattern = function(sPattern) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._addFilter = function(fnFilter) {
		this._aFilters.push(fnFilter)
		sap.ui.app.MockServer._addFilter(fnFilter);
	};
	 ...
	 * @private
	 */
	sap.ui.app.MockServer.prototype._createFilter = function(sRequestMethod, oRegExp) {
	 ...
	 * @public
	 */
	sap.ui.app.MockServer.prototype.destroy = function(bSuppressInvalidate) {
		sap.ui.base.ManagedObject.prototype.destroy.apply(this, arguments);
		this.stop();
		var aServers = sap.ui.app.MockServer._aServers;
	...
	sap.ui.app.MockServer._aFilters = [];
	sap.ui.app.MockServer._oServer = null;
	sap.ui.app.MockServer._aServers = [];
	 ...
	 * @private
	 */
	sap.ui.app.MockServer._getInstance = function() {
	 ...
	 * @param {boolean} [mConfig.autoRespond=true] If set true, all mock servers will respond automatically. If set false you have to call {@link sap.ui.app.MockServer#respond} method for response.
	 ...
	 */
	sap.ui.app.MockServer.config = function(mConfig) {
	 ...
	 */
	sap.ui.app.MockServer.respond = function() {
	 ...
	 */
	sap.ui.app.MockServer.startAll = function() {
	 ...
	 */
	sap.ui.app.MockServer.stopAll = function() {
		for (var i=0; i < this._aServers.length; i++) {
	 ...
	 */
	sap.ui.app.MockServer.destroyAll = function() {
		this.stopAll();
		for (var i=0; i < this._aServers.length; i++) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer._addFilter = function(fnFilter) {
		this._aFilters.push(fnFilter);
	};
	 ...
	 * @private
	 */
	sap.ui.app.MockServer._removeFilter = function(fnFilter) {
	 ...
	 * @private
	 */
	sap.ui.app.MockServer._removeResponse = function(fnResponse) {
	...
	window.sinon.FakeXMLHttpRequest.addFilter(function(sMethod, sUri, bAsync, sUsername, sPassword) {
		var aFilters = sap.ui.app.MockServer._aFilters;
	...
	var getMimeType = function(sFileName) {
		if (/.*\.json$/.test(sFileName)) {
			return "JSON";
		}
		if (/.*\.xml$/.test(sFileName)) {
			return "XML";
		}
		if (/.*metadata$/.test(sFileName)) {
