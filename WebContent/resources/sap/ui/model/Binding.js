 ...
 * The default implementation just fires the change event, if the method is called.
 * @private
 */
sap.ui.model.Binding.prototype.checkUpdate = function() {
	this._fireChange();
};
 ...
 * @public
 */
sap.ui.model.Binding.prototype.refresh = function() {
	this.checkUpdate();
};
