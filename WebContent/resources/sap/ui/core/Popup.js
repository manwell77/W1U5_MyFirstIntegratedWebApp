 ...
 * @private
 */
sap.ui.core.Popup.prototype.touchEnabled = sap.ui.Device.support.touch || jQuery.sap.simulateMobileOnDesktop;//(jQuery.sap.touchEventMode !== "OFF");
 ...
 * @private
 */
sap.ui.core.Popup.prototype.restoreFocus = !sap.ui.Device.support.touch && !jQuery.sap.simulateMobileOnDesktop;//(jQuery.sap.touchEventMode === "OFF");
 ...
 * @private
 */
sap.ui.core.Popup.prototype.focusOnPopup = !sap.ui.Device.support.touch && !jQuery.sap.simulateMobileOnDesktop;//(jQuery.sap.touchEventMode === "OFF");
...
* @private
*/
sap.ui.core.Popup.Layer = function() {
	var sDomString = this.getDomString();
	this._$Ref = jQuery(sDomString).appendTo(sap.ui.getCore().getStaticAreaRef());
};
sap.ui.core.Popup.Layer.prototype = jQuery.sap.newObject(sap.ui.base.Object.prototype);
/**
*
* @param oRef
* @param iZIndex
...
sap.ui.core.Popup.BlindLayer.prototype = jQuery.sap.newObject(sap.ui.core.Popup.Layer.prototype);
...
* @private
*/
sap.ui.core.Popup.ShieldLayer = function() {
	sap.ui.core.Popup.Layer.apply(this);
};
sap.ui.core.Popup.ShieldLayer.prototype = jQuery.sap.newObject(sap.ui.core.Popup.Layer.prototype);
...
sap.ui.core.Popup.prototype.open = function(iDuration, my, at, of, offset, collision, followOf) {
	...
	if(this.touchEnabled && !this._bModal && this._bAutoClose){
		jQuery(document).bind(jQuery.support.touch ? "touchstart" : "mousedown", jQuery.proxy(this._fAutoCloseHandler, this));
	}
...
sap.ui.core.Popup.prototype.close = function(iDuration) {
	...
	if(sap.ui.Device.os.ios && sap.ui.Device.support.touch){
		if(this._oShieldLayer){
			...
			jQuery.sap.clearDelayedCall(this._oShieldRemoveTimer);
		...
		this._sShieldRemoveTimer = jQuery.sap.delayedCall(400, this, function(){
			this.oShieldLayerPool.returnObject(that._oShieldLayer);
