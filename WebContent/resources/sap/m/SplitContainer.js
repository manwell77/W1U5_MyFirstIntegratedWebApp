...
sap.m.SplitContainer.prototype.ontap = function(oEvent) {
	if(!jQuery.device.is.phone) {
		...
		*/
		...
		if(!this._oldIsLandscape && oEvent._masterButtonClickedForSplitContainer) {
		...
		onBeforeShow: function(){
			if(oRealPage){
				if(!jQuery.device.is.phone){
					...
					if((oSplitContainer._portraitHide() || oSplitContainer._portraitPopover()) && (!oSplitContainer._bMasterisOpen || oSplitContainer._bMasterClosing)) {
	...
	if(oRealPage){
		oRealPage.addDelegate({
			...
			onBeforeRendering: function(){
				if(!jQuery.device.is.phone) {
					if(oSplitContainer._portraitHide()) {
...
/*
sap.m.SplitContainer.prototype._checkCustomHeader = function(oPage) {
...
/*sap.m.SplitContainer.prototype._existsOnParentChain = function(oSelfControl, middleType, oWithinContainer){
