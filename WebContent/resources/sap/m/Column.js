...
sap.m.Column.hasBorderBoxSupport = function() {
	var width = 5,
		...
		table = "<table style='table-layout:fixed; width:" + width + "px; position:absolute; left:-999px; top:-999px'>" +
	...
	$table.remove();
	$table = table = width = null; 	// maybe helps GC
	
	// overwrite the original method after first call
	this.hasBorderBoxSupport = function() {
...
sap.m.Column.prototype.onColumnRendered = function($table) {
	...
	if (!sap.m.Column.hasBorderBoxSupport() && this.hasOwnProperty("_index") && this.getWidth() && this.getVisible() && !this.isPopin() && !this.isNeverVisible()) {
