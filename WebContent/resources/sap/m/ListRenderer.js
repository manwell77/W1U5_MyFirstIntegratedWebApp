...
sap.m.ListRenderer.render = function(rm, oControl) {
    ...
    switch(oControl.getBackgroundDesign()){
    case sap.m.BackgroundDesign.Transparent:
    	rm.addClass("sapMListBGTransparent");
    	break;
    case sap.m.BackgroundDesign.Translucent:
    	rm.addClass("sapMListBGTranslucent");
    	break;
    case sap.m.BackgroundDesign.Solid:
    default:
    	rm.addClass("sapMListBGSolid");
    	break;  
    }
    ...
    if (oControl.getWidth()) {
        ...
        rm.addStyle("min-width", oControl.getWidth());
        rm.writeStyles();
    }
    rm.write(">");
...
sap.m.ListRenderer._renderColumns = function(rm, oList, type) {
    var index = 0,
        ...
        deleteOnRight = (sap.ui.core.theming.Parameters.get("sapMPlatformDependent") != "true" && mode == "Delete"),
    ...
    if (mode != "None" && mode != "SingleSelect" && !deleteOnRight) {
    ...
    if (mode == "SingleSelect" || deleteOnRight) {
        createBlankCell("SelCol");
    }
