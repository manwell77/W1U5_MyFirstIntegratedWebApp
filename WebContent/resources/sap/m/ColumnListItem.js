 ...
 */
sap.m.ColumnListItem.prototype._toggleActiveClass = function(b){
	if (this._popinId) {
		jQuery.sap.byId(this._popinId).toggleClass("sapMLIBActive",b);
	}
};
 ...
 */
//TODO: is it really necessary to have a static method for this? oLI already has this method...
sap.m.ColumnListItem.removePopin = function(oLI) {
	return oLI.removePopin();
};
 ...
 */
//TODO: it looks like the method should not be static, since oLI is used anyway
